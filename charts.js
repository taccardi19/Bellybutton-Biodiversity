  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: "The bar chart shows the top 10 bacterial species <br>and how many samples were found in the belly button",
        showarrow: false
      }]
    };
    ...
    var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "The gauge shows how often the belly button is washed in a week",
        showarrow: false
      }]
    };
